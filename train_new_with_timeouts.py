...
# _WAIT_OPENING_STATION_COEFF = 6
# _WAIT_TRAIN_COEFF = 20
# _WAIT_OPENING_DOORS_AT_SOURCE_STATION_COEFF = 4
# _WAIT_PASSENGERS_BOARDING_IS_OVER_COEFF = 6
...
#                         with self._passengers_quantity_on_train_lock:
#                             self._passengers_quantity_on_train.value += 1
#                         self._pause()
#                         with self._passengers_quantity_who_left_lock:
#                             self._passengers_quantity_who_left.value += 1
#                         self._pause()
